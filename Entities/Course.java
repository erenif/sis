...
public class Course {
    ...
    public WeekDays getCourse_day() { return course_day; }
    public void setCourse_day(WeekDays course_day) { this.course_day = course_day; }
    public String getSyllabus() { return syllabus; }
    public void setSyllabus(String syllabus) { this.syllabus = syllabus; }
    public ArrayList<Course> getPrerequisiteCourse() { return prerequisiteCourse; }
    public void setPrerequisiteCourse(ArrayList<Course> prerequisiteCourse) { this.prerequisiteCourse = prerequisiteCourse; }
